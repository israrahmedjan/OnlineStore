...
export default function productContent({ prodDetData }) {
    return (
        <>

            <p>Testing....{JSON.stringify(prodDetData, null, 2)}</p>
                            ...
                            <div className="row">
                                <div className="col-md-6 col-sm-6">
                                    <div className="product-main-image">
                                        <img src={prodDetData.title} alt="Cool green dress with red bell"
